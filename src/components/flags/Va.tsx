  ...
  >
    ...
    <g stroke="#000" strokeLinejoin="round" strokeWidth={3.2}>
      ...
      <g fill="#ce9d09" transform="matrix(-.192 0 0 .192 837 0)">
        <use xlinkHref="#va_svg__b" width="100%" height="100%" />
        <use xlinkHref="#va_svg__c" width="100%" height="100%" fill="#ccc" />
      </g>
      <g fill="#fa0204" transform="translate(123) scale(.192)">
        ...
        />
        <use xlinkHref="#va_svg__e" width="100%" height="100%" x={4} y={16.1} />
