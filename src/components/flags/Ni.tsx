...
const SvgNi = (props) => (
  ...
  >
    ...
    />
    <g clipPath="url(#ni_svg__c)" transform="matrix(.8 0 0 .8 -80 0)">
      ...
      <g fill="url(#ni_svg__h)">
        ...
        <g id="ni_svg__n" fill="url(#ni_svg__i)">
          <path
            id="ni_svg__k"
            fill="url(#ni_svg__j)"
      ...
      <g fill="#ccd11e">
        ...
        <use xlinkHref="#ni_svg__t" width="100%" height="100%" x={-15.3} />
        <g fill="#c6cb24">
          <path
            fill="url(#ni_svg__u)"
        ...
        <g id="ni_svg__w">
          ...
          <path
            fill="#97c924"
            d="M484.8 297.5q-1.2 0-1.6.3l-.3.3a43 43 0 0 1-8.1 15c-3.4 4.3-9.7 8.6-14 9l-4.3 7.5h48v-10.7a23 23 0 0 1-9.5-6 34 34 0 0 1-8.4-14.8l-.3-.3a3 3 0 0 0-1.5-.3"
          />
          <path
            fill="#93bc30"
      ...
      <g id="ni_svg__A">
        ...
        />
        <use xlinkHref="#ni_svg__z" width="100%" height="100%" y={-1.3} />
        <use xlinkHref="#ni_svg__z" width="100%" height="100%" y={-2.6} />
      </g>
      <use xlinkHref="#ni_svg__A" width="100%" height="100%" y={-3.9} />
      <use xlinkHref="#ni_svg__A" width="100%" height="100%" y={-7.7} />
      <path
        fill="#97c924"
