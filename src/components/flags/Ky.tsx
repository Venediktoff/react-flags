...
const SvgKy = (props) => (
  ...
  >
    ...
    >
      <use xlinkHref="#ky_svg__a" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__b" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__c" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__d" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__e" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__f" width="100%" height="100%" />
      <use xlinkHref="#ky_svg__g" width="100%" height="100%" />
    </g>
    <g
      stroke="#000"
      strokeWidth={1.4}
    ...
    <g strokeWidth={1.4} transform="translate(-306.8 -21.2) scale(.87136)">
      ...
      <use xlinkHref="#ky_svg__h" width="100%" height="100%" x={90.1} />
      <use xlinkHref="#ky_svg__h" width="100%" height="100%" x={45} y={52.2} />
      <path
        fill="none"
        stroke="#000"
        d="M989.7 233v93.4c0 81-38.3 108.8-89.6 130.8-51.3-22-90-49.8-90-130.8v-93.5h179.6z"
