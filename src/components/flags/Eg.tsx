...
const SvgEg = (props) => (
  ...
  >
    ...
    <g fill="#fff" stroke="#c09300" transform="matrix(.8 0 0 .8 -40 0)">
      ...
      />
      <g id="eg_svg__b" fill="none" strokeLinejoin="round" strokeWidth={1.3}>
        <path
          fill="#fff"
          strokeWidth={1.2}
