...
const SvgHk = (props) => (
  ...
  >
    ...
    />
    <use xlinkHref="#hk_svg__a" transform="rotate(72 312.5 243.5)" />
    <use xlinkHref="#hk_svg__a" transform="rotate(144 312.5 243.5)" />
    <use xlinkHref="#hk_svg__a" transform="rotate(216 312.5 243.5)" />
    <use xlinkHref="#hk_svg__a" transform="rotate(288 312.5 243.5)" />
  </svg>
);
