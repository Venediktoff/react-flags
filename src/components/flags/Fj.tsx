  ...
  >
    ...
    <g strokeMiterlimit={4.8}>
      ...
      <g fill="#964b36" stroke="#000" strokeWidth={0.3}>
        <path d="m542 299.8-.3.3.4-.3zm9.3-2.3q-.2-.2-.3-.2l-.4-.8h-.3l-.7-1.4v-.7s-.2 0-.3-.2v-1.6l-.1-.5-.3-1.1v-1q0-.5-.1-1l.1-.9v-5.4l-.1-1-.1-.4v-1.6 2.6l-.2-4.3-3.4-1.6s-.3 6.2-.2 7c0 .9.4 6.7.2 7.4l-.5 4.3s-1.6 1.2-2.2 2.4c-.7 1.3-.5 1.7-.7 1.7l1.5-.2-1.1.8.7.1.2.2.2-.2c.3 0 .5.4.7.3l.4-.2.2-.4h1.1q.5-.2.9-.7.3-.3.7-.3.4.1 1 .3.3 0 .5-.2l.4-.6.8-.1.4.1h.6l.3.2.2-.4z" />
        <path d="M544.5 299.7h.6v.2h.2l.3.2h.3l.4.1q.3.1.6-.1t.6.2q.1.2.2 0l.1-.1.3-.1.3-.1.4-.2.4.2h.2l.7-.5q.4-.1.7 0h.7q0-.1.2-.3l.7.4c.1.1.7.2.6-.2s-.4-.1-.5-.4v-.6l-.3-.4h-.4l-.2-.6-.3.2q-.2 0-.3-.3c-.3-.3-.4.2-.7.1q-.3-.2-.5-.7t-.5-.4q-.2.3 0 .7h-.5q-.2 0-.3.2-.2.7-.7.6h-.4l-.5.2h-.4l-.4-.4a.1.1 0 0 0-.2 0l-.1-.2q-.2 0-.3.3l-.1.5-.3.4-.4.1c-.2 0-.4.3-.4 0-.2-.4.3-1.1-.2-1q-.1 0-.3.2v.7c-.1.3-.7.8-.6 1 0 .3.4 0 .4 0l.2.4c.2.3.7-.4.7 0m-2.1-2.7v-.2l-.4-.1q-.3.1-.5.4c-.2.4-.2 1-.6 1h-.5v1s-.2 0-.2.2q0 .4.4.2h1l.5-.1q.3 0 .5-.2l.2-.4v-.4q.1-.1.3-.4c.1-.7-.6-.2-.5-.9" />
      </g>
      ...
      <g fill="#964b36" stroke="#000" strokeWidth={0.5}>
        <path
          strokeWidth={0.3}
          d="M549.4 334.8s5.6-7.4 10.6-5.5 8.1 3 8.1 3 .1 4.9-2.5 4.9-5.2-5-7.6-3.5a13 13 0 0 0-4.5 4.2c-.1.7-6.3.8-4.1-3.1z"
        />
