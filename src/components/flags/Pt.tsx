...
const SvgPt = (props) => (
  ...
  >
    ...
    <g transform="translate(0 26.7) scale(1.06667)">
      ...
      />
      <g id="pt_svg__e">
        <g id="pt_svg__d" fill="#ff0" stroke="#000" strokeWidth={0.5}>
          <path
            stroke="none"
          ...
          <path id="pt_svg__a" d="M191 141.6v3.4h-4v-3.4z" />
          <use xlinkHref="#pt_svg__a" width="100%" height="100%" x={10.6} />
          <path
            id="pt_svg__b"
            d="M186.3 139h1.2v1h.9v-1h1.2v1h.9v-1h1.2v2q0 .6-.5.6h-4.3a1 1 0 0 1-.6-.6z"
          />
          <use xlinkHref="#pt_svg__b" width="100%" height="100%" x={10.6} />
          <path
            fill="#000001"
            stroke="none"
          ...
          />
          <use xlinkHref="#pt_svg__c" width="100%" height="100%" x={10.6} />
        </g>
        <use xlinkHref="#pt_svg__d" width="100%" height="100%" y={46.3} />
        <use
          xlinkHref="#pt_svg__d"
          width="100%"
          height="100%"
      ...
      <use xlinkHref="#pt_svg__d" width="100%" height="100%" x={45.7} />
      <use
        xlinkHref="#pt_svg__e"
        width="100%"
        height="100%"
      ...
      <use xlinkHref="#pt_svg__f" width="100%" height="100%" y={-26} />
      <use xlinkHref="#pt_svg__f" width="100%" height="100%" x={-20.8} />
      <use xlinkHref="#pt_svg__f" width="100%" height="100%" x={20.8} />
      <use xlinkHref="#pt_svg__f" width="100%" height="100%" y={25.8} />
    </g>
  </svg>
);
